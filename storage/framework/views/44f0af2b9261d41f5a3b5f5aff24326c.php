...
<?php $__env->startSection('title', 'Form Pemesanan'); ?>
...
<div class="container mx-auto mt-10">
    <div class="bg-white shadow-lg rounded-lg p-6 border border-blue-300">
        ...
        <form action="<?php echo e(route('myorders.store')); ?>" method="POST" id="order-form">
            <?php echo csrf_field(); ?>
            ...
            newMenuItem.innerHTML = `
                ...
                <select name="menu_id[]" class="mt-1 block w-full rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 menu-select" required>
                    ...
                    <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($menu->id); ?>" data-harga="<?php echo e($menu->price); ?>" data-stok="<?php echo e($menu->stock); ?>" data-image="<?php echo e(asset('storage/' . $menu->image_url)); ?>">
                            <?php echo e($menu->name); ?> - Rp <?php echo e(number_format($menu->price, 0, ',', '.')); ?> (Stok: <?php echo e($menu->stock); ?>)
                        </option>
...
<?php echo $__env->make('layouts.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\examrestaurant\resources\views/myorders/create.blade.php ENDPATH**/ ?>